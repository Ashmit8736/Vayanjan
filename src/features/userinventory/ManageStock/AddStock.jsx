...
//   //     setRawMaterials(res.data.data); // 🔥 sirf data
//   //   } catch (err) {
//   //     console.error(err);
//   //   }
//   // };
...
// //     const items = rows
// //       .filter((r) => r.material && r.qty)
// //       .map((r) => ({
// //         raw_material_id: r.material,
...
//       .map((r) => ({
//         raw_material_id: Number(r.material),
//         quantity: Number(r.qty),          // 👈 backend field
//         unit_id: Number(r.unit),           // 👈 optional (agar backend use karta ho)
//         branch_id: 1                       // 👈 apni actual branch_id
//       }));
