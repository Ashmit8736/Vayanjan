...
//               <Box display="grid" gridTemplateColumns="3fr auto 1.5fr 1.5fr auto" gap={2} mb={1.5} px={1}>
...
//                   key={i}
//                   display="grid"
//                   gridTemplateColumns="3fr auto 1.5fr 1.5fr auto"
//                   gap={2}
//                   alignItems="center"
//                   mb={2}
//                 >
...
//                       handleEditMaterialChange(i, "raw_material_id", newValue ? newValue.id : "");
//                       if (newValue && newValue.consume_unit_id) {
//                         handleEditMaterialChange(i, "consume_unit_id", newValue.consume_unit_id);
//                       }
//                     }}
//                     renderInput={(params) => (
//                       <TextField
...
// ===== SEARCH FILTER CONFIG FOR RAW MATERIAL AUTOCOMPLETE =====
// matchFrom: "any" -> name ke beech mein bhi search match karega (not just starting letters)
// ignoreCase: true -> upper/lower case dono chalega
const rawMaterialFilterOptions = createFilterOptions({
  matchFrom: "any",
  ignoreCase: true,
  stringify: (option) => option?.name || "",
  limit: 50, // dropdown ko zyada heavy hone se bachane ke liye
});
            ...
            <Paper sx={{ p: 2 }}>
              ...
              {editForm.materials.map((m, i) => (
                <Box
                  ...
                  mb={2}
                >
                  {/* ===== SEARCHABLE RAW MATERIAL AUTOCOMPLETE ===== */}
                  <Autocomplete
                    options={rawMaterials}
                    filterOptions={rawMaterialFilterOptions}
                    autoHighlight
                    clearOnBlur={false}
                    getOptionLabel={(option) => (option ? option.name : "")}
                    ...
                    noOptionsText="No raw material found"
                    size="small"
                    fullWidth
                  />
