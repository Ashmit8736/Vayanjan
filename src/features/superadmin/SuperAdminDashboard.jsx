...
const SuperAdminDashboard = () => {
    ...
    return (
        <Box sx={{ display: 'flex', height: '100vh', bgcolor: '#F5F7FA' }}>
            <Box sx={{ width: 260, bgcolor: '#FFFFFF', borderRight: '1px solid #EDEDED', display: 'flex', flexDirection: 'column', boxShadow: '4px 0 24px rgba(0,0,0,0.02)', zIndex: 1200 }}>
                <Box sx={{ p: 4, display: 'flex', alignItems: 'center' }}>
                    <Box sx={{ bgcolor: 'linear-gradient(135deg, #FF5722 0%, #FF8A65 100%)', background: 'linear-gradient(135deg, #FF5722 0%, #FF8A65 100%)', borderRadius: 2, width: 36, height: 36, mr: 2, boxShadow: '0 4px 12px rgba(255, 87, 34, 0.3)' }} />
                    <Typography variant="h5" fontWeight="800" sx={{ background: 'linear-gradient(45deg, #1A1A1A 30%, #424242 90%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                        Vyanjan
                    </Typography>
                </Box>
                ...
                <List sx={{ px: 2, flexGrow: 1 }}>
                    <ListItem disablePadding sx={{ mb: 1, mt: 1 }}>
                        <Typography variant="caption" color="text.secondary" sx={{ pl: 2, fontWeight: '700', letterSpacing: '1px', opacity: 0.7 }}>
                            OVERVIEW
                        </Typography>
                    </ListItem>
                ...
                <Box sx={{ mt: 'auto', p: 3, borderTop: '1px solid #EDEDED', bgcolor: '#FAFAFA' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, gap: 1.5 }}>
                        <Avatar sx={{ width: 32, height: 32, bgcolor: '#FFF3E0', color: '#EF6C00', border: '1px solid #FFE0B2' }}>
                    ...
                    <Typography variant="caption" display="block" color="text.secondary" sx={{ lineHeight: 1.6, mb: 2, fontWeight: 500 }}>
